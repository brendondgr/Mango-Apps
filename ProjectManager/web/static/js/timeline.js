...
class TimelineRenderer {
    ...
    handleTimeRangeChange(rangeKey) {
        ...
        const endpoint = projectId ? `/pr/projects/api/timeline/project/${projectId}` : '/pr/projects/api/timeline/dashboard';
    ...
    handleFilterChange() {
        ...
        const projectId = this.container.dataset.projectId;
        let url = projectId ? `/pr/projects/api/timeline/project/${projectId}` : '/pr/projects/api/timeline/dashboard';
...
const timelineManager = {
    ...
    handleItemClick(event, containerId, itemId, itemType) {
        ...
        if (itemType === 'project') {
            ...
            tempBtn.setAttribute('hx-get', `/pr/projects/project/${itemId}/details`);
